...
from .plugin.probackup.app import ProbackupApp
from .plugin.probackup.storage.fs_backup import FSTestBackupDir
import importlib
...
elif os.environ.get('PROBACKUP_S3_TYPE_FULL_TEST'):
...
class ProbackupTest(unittest.TestCase):
    ...
    tests_source_path = init_params.tests_source_path
    ...
    def wait_instance_wal_exists(self, backup_dir, instance, file, timeout=20):
        start = time.time()
        fl = f'wal/{instance}/{file}'
