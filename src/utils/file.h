...
#define iface__pioReadSeek			mth(pioRead, pioSeek)
...
typedef struct pio_recursive_dir pioRecursiveDir;
extern pioRecursiveDir* pioRecursiveDir_alloc(pioDrive_i drive, path_t root, err_i *err);
extern pio_dirent_t pioRecursiveDir_next(pioRecursiveDir* dir, err_i* err);
extern void pioRecursiveDir_dont_recurse_current(pioRecursiveDir* dir);
extern void pioRecursiveDir_close(pioRecursiveDir* dir);
