...
OBJS += src/compatibility/file_compat.o src/compatibility/receivelog.o \
	src/compatibility/simple_prompt.o  src/compatibility/streamutil.o \
	src/compatibility/walmethods.o

# borrowed files
OBJS += src/pg_crc.o src/xlogreader.o
# src/receivelog.o src/streamutil.o \
...
PG_CPPFLAGS = -I$(libpq_srcdir) ${PTHREAD_CFLAGS} -Isrc -I$(srchome)/$(subdir)/src -Isrc/compatibility -Isrc/utils
